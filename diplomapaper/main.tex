...
a4paper, % Хуудасны хэмжээ: needtoedit.pdf-тэй ижил A4
...
\usepackage[T2A]{fontenc} % CM-Super (Computer Modern with Cyrillic/Mongolian)
\else
\usepackage{fontspec}
...
\usetikzlibrary{shapes,arrows,arrows.meta,automata}
...
\usepackage[backend=biber,natbib=true,sorting=none,sortcites]{biblatex} % Ном зүйд Unicode-д тохиромжтой Biber backend ашиглах
...
\newcommand{\constantsname}{Платформын тогтмолууд}
...
\thesistitle{Монгол улсын загварын сэтгүүлийн платформ хөгжүүлэх} % Таны ажлын нэр, нүүр болон хураангуй хуудсанд ашигласан. Өөр газарт бол \ttitle командыг хэрэглэнэ
\thesistype{БАКАЛАВРЫН ДИПЛОМЫН АЖИЛ} % Удирдагчийн нэр, нүүр хуудсанд ашиглана. Дурын газарт бол \thesisname командыг хэрэглэнэ
\supervisor{Магистр (MSc), Э.Батцэцэг} % Удирдагчийн нэр, нүүр хуудсанд ашиглана. Дурын газарт бол \supname командыг хэрэглэнэ
\reader{---} % Шүүмжлэгчийн нэр, Дурын газарт бол \readname командыг хэрэглэнэ
\advisor{Доктор (Ph.D), Дэд профессор Б.Туяацэцэг}  % Зөвлөгчийн нэр, Дурын газарт бол \advicename командыг хэрэглэнэ
\degreeind{061301000000002306} % Мэргэжлийн индекс, нүүр болон хураангуй хуудсанд ашигласан. Өөр газарт бол \degreeid командыг хэрэглэнэ
\degree{Компьютерын ухаан} % Боловсролын зэрэг, нүүр болон хураангуй хуудсанд ашигласан. Дурын газарт бол \degreename командыг хэрэглэнэ
\authorshort{Ө.Анхтуяа} % Таны товч нэр, нүүр болон хураангуй хуудсанд ашигласан. Дурын газарт бол \shortname командыг хэрэглэнэ 
\authorlong{Өлзийтогтох Анхтуяа} % Таны бүтэн нэр, нүүр болон хураангуй хуудсанд ашигласан. Дурын газарт бол \longname командыг хэрэглэнэ 
\addresses{ankhtuyaulziitogtokh@gmail.com} % Таны хаяг, одоогоор ашиглаагүй. Өөр газарт бол \addressname команд��г хэрэглэнэ
\subject{Компьютерийн ухаан} % Таны салбар, одоогоор ашиглаагүй. Дурынр газарт бол \subjectname командыг ашиглана
\keywords{Монголын загвар, дижитал архив, веб платформ, Next.js, React, CouchDB, Supabase, RAG, AI чатбот} % Түлхүүр үгс, одоогоор ашиглаагүй. Дурын газарт бол \keywordnames командыг хэрэглэнэ
...
\usepackage{bookmark}
\geometry{inner=3.0cm, outer=2.0cm, top=2.0cm, bottom=2.5cm}
\setcounter{secnumdepth}{2}
\setcounter{tocdepth}{2}

% MUST-Thesis.cls uses \bffamily in chapter headings; keep chapter titles non-bold.
\let\bffamily\mdseries
...
\bookmarksetup{startatroot} % Start chapters as new root (expanded)
\bookmarksetup{level=1} % Expand chapter sections in bookmarks
