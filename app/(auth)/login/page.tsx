...
const quotes = [
  { text: '"Fashion is the armor to survive the reality of everyday life."', author: '— Nomin D.' },
  { text: '"The steppe taught us that beauty lives in restraint."', author: '— Goyol Studio' },
  { text: '"Every thread carries the memory of the herd."', author: '— Gobi Cashmere' },
]
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:block lg:w-[55%] relative bg-[#0A0A0A] overflow-hidden">
        ...
        <div className="hidden" onClick={() => setQuoteIndex((prev) => (prev + 1) % quotes.length)} />
      </div>
        ...
        <div className="max-w-sm w-full mx-auto">
          ...
          <div className="flex gap-8 mb-12">
            <button
              ...
              className={`font-sans text-[11px] tracking-[2px] uppercase pb-2 transition-colors ${
                isSignIn ? 'border-b-2 border-[#2A2522] text-[#2A2522]' : 'text-[#B7AEA9]'
              }`}
            >
              Sign In
            </button>
          ...
          {searchParams.get('error') === 'use_admin_login' && (
            <div className="mb-6 p-4 bg-amber-50 border border-amber-200 font-sans text-[12px] text-amber-700">
              ...
              <a href="/admin/login" className="underline font-bold">CMS login</a>
              {' '}instead.
            </div>
          )}
          ...
          <AnimatePresence mode="wait">
            {isSignIn ? (
              ...
              >
                <h2 className="font-serif text-3xl text-[#2A2522] mb-2">Welcome back</h2>
                <p className="font-sans text-[13px] text-[#B7AEA9] mb-10">Sign in to your archive</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <a href="#" className="font-sans text-[11px] text-[#B7AEA9] hover:text-[#2A2522] transition-colors">
                        Forgot password?
                      </a>
                    </div>
                ...
                <div className="flex items-center gap-4 my-8">
                  ...
                  <span className="font-sans text-[11px] text-[#B7AEA9]">or</span>
                  <div className="flex-1 h-px bg-[rgba(0,0,0,0.08)]" />
                </div>
              ...
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <h2 className="font-serif text-3xl text-[#2A2522] mb-2">Join the Archive</h2>
                <p className="font-sans text-[13px] text-[#B7AEA9] mb-10">Create your account</p>
