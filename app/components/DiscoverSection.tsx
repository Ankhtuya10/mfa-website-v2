...
export const DiscoverSection = () => {
  const [featured, setFeatured] = useState<FeaturedDiscover>(null);
  ...
  const titleParts = featured ? splitTitle(featured.title) : null;
        ...
        {featured && titleParts && (
          ...
          >
            ...
            <div className="relative z-10 flex items-center gap-5">
              <Button href={featured.link}>{featured.link_label}</Button>
