...
export function DesignerCard({ designer, variant = 'grid' }: DesignerCardProps) {
  ...
  const tierLabel = designer.tier === 'high-end' ? 'High-End' 
    : designer.tier === 'contemporary' ? 'Contemporary' 
    : 'Emerging'
