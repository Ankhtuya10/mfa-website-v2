          ...
          {designers.length === 0 ? (
            ...
            designers.map((d) => (
              ...
              >
                ...
                <td className="py-4 px-5 font-inter text-[13px] text-[#111111] font-medium">
                  {d.name}
                </td>
                <td className="py-4 px-5">
                  <span
                    className={`font-sans text-[10px] tracking-[2px] uppercase px-2 py-1 ${tierStyles[d.tier || ""] || tierStyles["emerging"]}`}
                  >
                    {d.tier || "emerging"}
                  </span>
                </td>
                <td className="py-4 px-5 font-inter text-[13px] text-[#555555]">
                  {d.founded || "-"}
                </td>
                <td className="py-4 px-5 font-inter text-[13px] text-[#555555] text-center">
                  {d.active_seasons || 0}
                </td>
                <td className="py-4 px-5">
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="text-[#9B9590] hover:text-red-500 transition-colors p-1"
                    >
