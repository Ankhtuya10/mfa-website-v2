...
await putDoc({
  ...
  bio: "Нарантуяа Галбадрах 'Нүүдэл Studio'-г 2021 онд Улаанбаатарт нээж, нүүдэлчдийн амьдралын хэв маяг, тал нутгийн өнгө аяс, чулуутай газрын дүрслэлийг хотын орчин үеийн загварт шилжүүлдэг. Ноолуур, тэмээний ноос, лавсан гэх мэт уламжлалт материалыг орчин үеийн эсгүүртэй нийлүүлж, 'өдөр тутмын уран бүтээл' гэсэн философийг баримталдаг. Тэр дизайны боловсролоо Сеулд эзэмшсэн.",
...
await putDoc({
  ...
  year: 2024,
  description:
    "Өвлийн хишиг цуглуулга нь Монгол нутгийн хүйтэн цагийн гоо зүйн тухай яруу найраг шиг өгүүлдэг. Мөсөн уулын цагаан өнгийг тод улаан дээлтэй нийлүүлж, хурган малгай, мөнгөн зүүлт чимэглэлийг орчин үеийн загварт шингээжээ. 8 дүрс бүхий энэ цуглуулга FW 2024 улиралд Улаанбаатарт дэлгэгдсэн.",
  cover_image: urls.deel_red_runway,
  ...
  looks: [
    ...
    },
    {
      ...
      description: "Ар талын харагдац. Хурган ноосон малгайн давхрага болон нурууны торгон хэвлэмэл. Ноосон сүлжмэлийн нарийн дэлгэрэнгүй харагдац.",
...
await putDoc({
  ...
  year: 2025,
  description:
    "Нүүдэлчний дуу цуглуулга нь тал нутгийн чөлөөт агаарыг хотын орчин үеийн загварт авчрах оролдлого юм. Цагаан, бор, хөх ногоон өнгийг давхарлан ашиглаж, нүүдэлчдийн уян хатан байдал, хөнгөн чанарыг илэрхийлжээ. SS 2025 улиралд 4 дүрс бүхий байдлаар танилцуулагдсан.",
  ...
  occasions: ["өдөр тутмын", "зуны баяр", "гудамжны загвар"],
  looks: [
    {
      id: "look-1",
      number: 1,
    ...
    },
    {
      ...
      description: "Нарны гэрэлд монгол торгон цагаан дээл. Залуу загварч — нарны тусгал, цэнгэг загвар. Уламжлал ба орчин үеийн зааг дээр.",
    ...
    },
    {
      ...
      description: "Хүрэн монгол дэгэл, үслэг малгай. Уламжлалт зүүлт, мөнгөн медал. Нүүдэлчний дайчин сүр хийморийг өнөө үед дахин амилуулсан дүрс.",
...
await putDoc({
  ...
  body:
    "Монгол дээл бол зүгээр нэг уламжлалт хувцас биш — энэ нь нүүдэлчдийн философи, байгаль цаг уурт нийцсэн мэргэн ухаан, гоо зүйн ертөнцийн нэгдсэн илэрхийлэл юм. Дээлний өргөн ханцуй нь морь унахад тохиромжтой, урт хормой нь хүйтнийг дарна, бүс нь дотоод дулааныг хадгалдаг — энэ бүгд зохион байгуулалтын мэдлэгийн үр дүн.\n\nОрчин үеийн Монгол загварчид энэ уламжлалыг хуулбарлахаас илүүтэй дахин ярьж байна. Батцэцэг Нямдаваагийн 'Говийн Ногоон' брэнд нь улаан торгыг цагаан малгайтай нийлүүлж, мөнгөн чимэглэлийг орчин үеийн нарийн зүүлтэй хослуулдаг. Ингэснээр тэр хувцасны дотор нуугдсан утгыг устгахгүйгээр шинэ хэлэнд орчуулдаг.\n\nЭнэ дахин тайлбарлах үйл явц нь зөвхөн загварын асуудал биш. Монголын залуу дизайнерууд хувцасаараа нутаг усаа, өөрсдийн хэн болохоо ярьдаг болжээ. Арьс өнгө, нүд хамар, мөнгөн зүүлт — энэ бүгд дэлхийн тавцанд Монгол хэн болохыг тодорхойлох шинэ хэл болж байна.",
  related_looks: [
    {
      lookId: "look-1",
      lookNumber: 1,
...
await putDoc({
  ...
  body:
    "Нарантуяа Галбадрах хотын ертөнцөд нүүдэлчний сэтгэлгээг авчрах нь зэрлэг цэцгийг аквариумд тавихтай адил биш гэдгийг онцолдог. 'Нүүдэлчин хаана ч тогтдоггүй, харин хаана байгаагаа бүрэн мэдэрдэг. Энэ нь загварын дизайнд ч тусдаг — хөдөлгөөнтэй, орон зайд мэдрэмтгий, дасан зохицдог' гэж тэр хэлнэ.\n\nТэрээр 'Нүүдэл Studio'-г Сеулд боловсрол эзэмшиж ирсний дараа нэн даруй байгуулжээ. Эхний цуглуулгадаа тэмээний ноосон хөнжил болон дотоод хувцас хийжээ — эдгээр нь нааш цааш нэлдэг, хоёр зүг тийш тэгш харагддаг, давхарласан ч хялбар байдаг. Хэрэглэгчид 'ямар нэгэн нэрлэхэд хэцүү зүйл мэдэрдэг' гэж хэлдэг байсан гэнэ.\n\nОдоо тэр SS 2025 цуглуулгаараа тал нутгийн агаарыг шууд хотын дундуур авчирч байна. Ойлгогдох байдлаар биш — мэдрэхүйгээр.",
  created_at: now,
  updated_at: now,
});
...
await putDoc({
  ...
  body:
    "2025 оны зуны трэнд нэг зүйлийг тодорхой харуулж байна: гоёл чимэглэл бол дагалдах зүйл биш, харин гол илэрхийлэл болжээ. Барок сувдны зүүлт, бугуйвч, хүзүүвч нь 'цэвэр' гоёлын шинэ стандарт болж байна. Тэдгээр нь тэгш биш, хэлбэр нь тогтворгүй, харин яг тэрхүү онцгой байдал нь бусдаас ялгаруулдаг.\n\nГуталны хувьд энэ зун хоёр чиг хандлага нэгэн зэрэг давамгайлж байна: нэг талаас хатуу арьсан, бат бэх оёдолтой сонгодог товч гутал, нөгөө талаас шаргал өнгөтэй цагаан квадрат хошуутай дунд өсгийтэй гутал. Хоёулаа 'цэгцтэй' байдлыг илэрхийлдэг.\n\nЦүнхний хувьд бежевий жижиг гар цүнх тодорхой сонголт хэвээр байна. Хэлхэлцсэн бугуйвчтэй хослуулбал ганц харцаар хангалттай хэлдэг.",
  related_looks: [
    {
...
await putDoc({
  ...
  body:
    "Ногоон, хүрэн, мөнгөн — байгалийн өнгийг гаднаас нааш биш, хүний биеийн хэлбэрт шингээх. Авант-гарде загварын мэдрэмж нь монгол зан заншлын 'байгальтай нэг байх' философитой нийтлэг зүйл олдож байна.\n\nФеликс Янгийн энэ зураглалд загварч хуяг дуулга мэт мөрний бүтэцтэй, ногоон жигд эд болон мөнгөн металл чимэглэлийг нийлүүлсэн дүрслэл авант-гардын хамгийн шинэ чиг хандлагыг илтгэнэ. Монгол уламжлалтай нийцэх нь: хуяг дуулга нь дайчин сэтгэлийг, ногоон нь байгалийн ухамсрыг, мөнгөн хавтгай нь нарны тусгалыг дамжуулна.\n\nДэлхийн загварын тавцанд авант-гарде биш 'байгалийн авант-гарде' гэсэн ойлголт урган гарч байна. Монгол дизайнерууд энэ ойлголтыг хамгийн органик байдлаар илэрхийлж чадах байрлалд байгаа нь тодорхой.",
  created_at: now,
  updated_at: now,
});
...
await putDoc({
  ...
  body:
    "Тал нутгийн дунд зогсоод нар жаргах үеийн өнгийг харах нь — ямар ч фото засварлагаагүйгээр ч хангалттай гоо зүйтэй. Монгол нүүдэлчдийн хувцас яг ийм үзэгдэлтэй уялдаж байдаг. Тод улаан, жирийн цагаан, хүрэн арьс — эдгээр нь байгалийн дэвсгэртэй тэмцэлдэхгүй, харин нэгэн ертөнц болдог.\n\nФото урлагт нүүдэлчдийн хувцасны дүрслэл сүүлийн жилүүдэд ихэссэн. Загварын журнал, хотын зурагт, хэрэглэгчдийн агуулга — бүгдэд л тал нутгийн уудам байдал, хувцасны хөдөлгөөн, малгайн цэгцтэй дүрс нийтлэг болов.\n\nЭнэ нь зөвхөн гоо зүйн трэнд биш — нутаг орноо үзүүлэх хүсэл эрмэлзлэл, зурагт дүрслэлээр дамжуулан өөрсдийн хэн болохоо хэлэх чадвар юм.",
  created_at: now,
  updated_at: now,
});
